...
import me.deprilula28.gamesrob.utility.MinMaxAI;
...
public class Blackjack extends TurnMatchHandler {
    private static final String[] ITEMS = {
            "⭕", "❌", "❗", "❓", "🍆"
    };
    public static final GamesInstance GAME = new GamesInstance(
            "blackjack", "blackjack blackj bjack bj",
            1, ITEMS.length - 1, GameType.MULTIPLAYER, false, true,
            Blackjack::new, Blackjack.class, Collections.singletonList(new GamesInstance.GameMode("reversettt", "reverse rev reversed inverted donttictactoe")));
    private int tiles = 9;
